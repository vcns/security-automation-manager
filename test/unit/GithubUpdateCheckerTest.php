...
class GithubUpdateCheckerTest extends TestCase {
	...
	public function test_new_manifest_version_populates_native_update_response(): void {
		$GLOBALS['_wp_remote_get_response'] = $this->response( $this->manifest( '2.4.8' ) );
		...
		$this->assertSame( '2.4.8', $item->new_version );
		$this->assertSame( 'https://vcns.github.io/wp-updates/security-automation-manager/security-automation-manager-github-v2.4.8.zip', $item->package );
	...
	public function test_plugin_information_modal_uses_manifest_sections(): void {
		...
		$this->assertSame( '2.4.8', $result->version );
