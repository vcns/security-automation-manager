...
class Provider_Dnsmadeeasy extends Dns_Provider {
	...
	private function zone( string $fqdn ): array {
		...
		throw new \RuntimeException( "DNS Made Easy: no managed domain found for {$fqdn}." ); // phpcs:ignore WordPress.Security.EscapeOutput.ExceptionNotEscaped -- exception message, never echoed as HTML; only logged via Audit_Log/record_run().
	}
