 ...
 * control had the intended effect. This build only confirms state locally
 * -- what the server is configured to send. Independently confirming what
 * an external client actually receives is External Verification (§20), a
 * future phase, and is not available yet.
 *
 * Deliberately minimal -- there is genuinely little else to honestly show
 * here until external verification exists.
 *
...
<div class="wrap wp-sam-wrap">
	...
	<p>
		<?php esc_html_e( 'This build only confirms state locally -- what this server is configured to send. Independently confirming what an external visitor actually receives is planned for a future phase and is not available yet.', 'vcns-security-automation-manager' ); ?>
	</p>
