...
<div class="wp-sam-table-wrap">
<table class="widefat striped wp-sam-table wp-sam-hash-inventory-table" style="margin-top:1em">
	<thead>
		<tr>
			<th class="wp-sam-col-surface"><?php esc_html_e( 'Surface', 'vcns-security-automation-manager' ); ?></th>
	...
	<tbody>
		...
		<tr>
			<td colspan="7"><?php esc_html_e( 'No first-party scripts or stylesheets have been hashed yet. Enable a surface above and browse the live site to build the inventory.', 'vcns-security-automation-manager' ); ?></td>
		</tr>
		<?php endif; ?>
	</tbody>
</table>
